...
export default {
  ...
  facebook: {
    ...
    embedUrl: 'https://www.facebook.com/plugins/post.php?href=https://www.facebook.com/<%= remote_id %>&height=300',
    html: "<iframe scrolling='no' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%; min-height: 350px; max-height: 1000px;'></iframe>",
    id: (ids) => {
      return ids.join('/');
    },
    height: 320
  ...
  soundcloud: {
    // https://on.soundcloud.com/a2HRX
    // https://soundcloud.com/user-111793832/0f3utbvemfkq

    regex: /^((?:https?:\/\/)?(?:on.)?(?:www.)?(?:soundcloud\.com|snd\.sc)\/(?:.*))/,
